...
var DataTablevue_type_script_lang_tsx_DataTable = class DataTable extends external_Vue_default.a {
  ...
  render() {
    ...
    }, [this.getParsedCustomer(this.mainData).map(element => h("tr", [h("td", [element.users.first_name]), h("td", [element.users.last_name]), h("td", [element.sites.name])]))])])]);
  }
